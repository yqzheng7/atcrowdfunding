...
import com.atguigu.crowd.constant.ResourcesAllowedToAccess;
...
public class CrowdAccessFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        ...
        boolean result = ResourcesAllowedToAccess.RESOURCES_ALLOWED_TO_ACCESS.contains(servletPath);
        ...
        return !ResourcesAllowedToAccess.isStaticResourcesAllowedToAccess(servletPath);
    }
